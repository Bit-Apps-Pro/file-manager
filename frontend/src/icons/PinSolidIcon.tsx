...
export default function PinSolidIcon({ size = '1em', className }: IconTypes) {
  return (
    <AntIconWrapper>
      <svg height={size} width={size} className={className} viewBox="0 0 16 16" fill="currentColor">
        <path
          d="M9.828.722a.5.5 0 0 1 .354.146l4.95 4.95a.5.5 0 0 1 0 .707c-.48.48-1.072.588-1.503.588c-.177 0-.335-.018-.46-.039l-3.134
