    ...
    public function connector()
    {
        ...
        $opts                  = [
            ...
            'roots' => [
                [
                    ...
                    'accessControl'   => [$accessControlProvider, 'control'],
                    'acceptedName'    => [$accessControlProvider, 'validateName'], // https://github.com/Studio-42/elFinder/wiki/Connector-configuration-options-2.1#acceptedName
        ...
        if ($preferences->isTrashAllowed()  && is_writable(FM_WP_UPLOAD_DIR['basedir'])) {
            $opts['roots'][] = [
                ...
                'accessControl' => [$accessControlProvider, 'control'],
                'acceptedName'  => [$accessControlProvider, 'validateName'],              // Same as above
